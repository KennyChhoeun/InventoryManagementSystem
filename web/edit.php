...
$conn = new mysqli("us-cdbr-east-05.cleardb.net","CREDENTIALS","CREDENTIALS","heroku_980dce8454d6e8d");
...
if( $_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    do {
        ...
        $sql = "UPDATE PRODUCTS SET make = '$make', model = '$model', product_condition = '$location', quantity = '$quantity' where SKU = '$SKU'";

        $result = $conn->query($sql);

        if(!$result) {
            $errorMessage = "Invalid change: " . $conn->error;
            break;
        }
